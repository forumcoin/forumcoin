...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.2 * COIN;	// 20% monthly interest
...
static const uint256 hashGenesisBlock("0x000007c0c2b92122dd3e6ef9de4953f3845d20d0cf331fc1e1bceeec5cc14fee");
static const uint256 hashGenesisBlockTestNet("0x000007c0c2b92122dd3e6ef9de4953f3845d20d0cf331fc1e1bceeec5cc14fee");
...
public:
    ...
    {
        // forumcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // forumcoin: get transaction coin age
...
public:
    ...
    // forumcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // forumcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // forumcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // forumcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // forumcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // forumcoin: block index flags
    enum  
    {
